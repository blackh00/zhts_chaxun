...
function initFanwe(&$server)
{
	...
	if(!defined('IS_UPYUN') && file_exists(FANWE_ROOT."Data/yun/UpYun.php"))
	{
		$upyun = @include(FANWE_ROOT."Data/yun/UpYun.php");
		if($upyun = @include(FANWE_ROOT."Data/yun/UpYun.php"))
		{
	...
	define('PUBLIC_ROOT', ROOT_PATH.'/Data/');
	define('PUBLIC_PATH', $_FANWE['site_root'].'Data/');
...
{
	$config = array();
	@include ROOT_PATH.'./Conf/config.global.php';
...
{	
	$domain_array = array(
	    ...
	    base64_encode(base64_encode('test.17558.net'))
	);
