$('.jisuanqi_num>li>input').hover(function(){
	$(this).addClass('on');
	},function(){
	$(this).removeClass('on');
	})
$('.jisuanqi_num2>li>input').hover(function(){
	$(this).addClass('on');
	},function(){
	$(this).removeClass('on');
	})
...
$(function () {
	...
	tabs(".jisuanqi_qiehuan", "on", ".jisuanqi_box");//计算器
});
...
function inputChangCarry(newcarry,ent){
	...
	document.calc.sin.style.color = (carry != 10)?"#aca899":"#262827";
		document.calc.sin.style.background = (carry != 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -160px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -128px";
	document.calc.cos.style.color = (carry != 10)?"#aca899":"#262827";
		document.calc.cos.style.background = (carry != 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -160px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -128px";
	document.calc.tan.style.color = (carry != 10)?"#aca899":"#262827";
		document.calc.tan.style.background = (carry != 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -160px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -128px";
	document.calc.bt.style.color = (carry != 10)?"#aca899":"#262827";
		document.calc.bt.style.background = (carry != 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -160px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -128px";
	document.calc.pi.style.color = (carry != 10)?"#aca899":"#262827;";
		document.calc.pi.style.background = (carry != 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -160px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -128px";
	document.calc.e.style.color = (carry != 10)?"#aca899":"#262827;";
		document.calc.e.style.background = (carry != 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -160px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -128px";
	
		
	document.calc.kp.style.color = (carry != 10)?"#aca899":"#262827";
		document.calc.kp.style.background = (carry != 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.k2.style.color = (carry <= 2)?"#aca899":"#262827";
		document.calc.k2.style.background = (carry <= 2) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.k3.style.color = (carry <= 2)?"#aca899":"#262827";
		document.calc.k3.style.background = (carry <= 2) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.k4.style.color = (carry <= 2)?"#aca899":"#262827";
		document.calc.k4.style.background = (carry <= 2) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.k5.style.color = (carry <= 2)?"#aca899":"#262827";
		document.calc.k5.style.background = (carry <= 2) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.k6.style.color = (carry <= 2)?"#aca899":"#262827";
		document.calc.k6.style.background = (carry <= 2) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.k7.style.color = (carry <= 2)?"#aca899":"#262827";
		document.calc.k7.style.background = (carry <= 2) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.k8.style.color = (carry <= 8)?"#aca899":"#262827";
		document.calc.k8.style.background = (carry <= 8) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.k9.style.color = (carry <= 8)?"#aca899":"#262827";
		document.calc.k9.style.background = (carry <= 8) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	
	document.calc.ka.style.color = (carry <= 10)?"#aca899":"#262827";
		document.calc.ka.style.background = (carry <= 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.kb.style.color = (carry <= 10)?"#aca899":"#262827";
		document.calc.kb.style.background = (carry <= 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.kc.style.color = (carry <= 10)?"#aca899":"#262827";
		document.calc.kc.style.background = (carry <= 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.kd.style.color = (carry <= 10)?"#aca899":"#262827";
		document.calc.kd.style.background = (carry <= 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.ke.style.color = (carry <= 10)?"#aca899":"#262827";
		document.calc.ke.style.background = (carry <= 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
	document.calc.kf.style.color = (carry <= 10)?"#aca899":"#262827";
		document.calc.kf.style.background = (carry <= 10) ? "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 -32px" : "url("+CONFIG['imgPath']+"/calculate/jisuanqi_bt2.gif) no-repeat 0 0px";
...
var showCalculator = function(idx,obj){
	...
	if(idx){
		...
		//sc_get("calculator_complete_container").style.backgroundImage = "url("+CONFIG['imgPath']+"/calculator//siverbg2.png)";
		bdjs.setHeight(585);
	}else{
...
window.onload = function(){
	...
	for(var i=0;i<buttons.length;i++){
		...
		buttons[23].onmousedown = function(){
			this.style.backgroundPosition = "0 -200px";
			//this.style.color = "#f0f0f0";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -160px";
		...
		buttons[19].onmousedown = function(){
			this.style.backgroundPosition = "0 -120px";
			//this.style.color = "#f0f0f0";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -80px";
	...
	//高级计算器的按钮效果
	for(var i=0;i<complete_buttons.length-6;i++){
		...
		//清存 全清 等号 按钮样式调整
		complete_buttons[6].onmousedown = function(){
			this.style.backgroundPosition = "0 -96px";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -64px";
			}
		}
		complete_buttons[7].onmousedown = function(){
			this.style.backgroundPosition = "0 -96px";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -64px";
			}
		}
		complete_buttons[30].onmousedown = function(){
			this.style.backgroundPosition = "0 -96px";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -64px";
			}
		...
		//加减乘除按钮样式调整
		complete_buttons[11].onmousedown = function(){
			this.style.backgroundPosition = "0 -160px";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -128px";
			}
		}
		complete_buttons[17].onmousedown = function(){
			this.style.backgroundPosition = "0 -160px";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -128px";
			}
		}
		complete_buttons[23].onmousedown = function(){
			this.style.backgroundPosition = "0 -160px";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -128px";
			}
		}
		complete_buttons[29].onmousedown = function(){
			this.style.backgroundPosition = "0 -160px";
			this.onmouseup = function(){
				this.style.backgroundPosition = "0 -128px";
			}
	...
	// A B C D E F 按钮样式调整
	for(var i=complete_buttons.length-6;i<complete_buttons.length;i++){
		complete_buttons[i].onmousedown = function(){
