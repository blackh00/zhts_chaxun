  var sWeek = new Array("星期日","星期一","星期二","星期三","星期四","星期五","星期六"); 
       ...
       total = (tmp - 1921) * 365 + Math.floor((tmp - 1921) / 4) + madd[TheDate.getMonth()] + TheDate.getDate() - 38;
        ...
        function GetLunarDay(solarYear,solarMonth,solarDay) {
			...
			} else { solarMonth = (parseInt(solarMonth)>0) ? (solarMonth-1) : 11; e2c2(solarYear,solarMonth,solarDay); return GetcDateString(); }
		} 
        var D=new Date(); 
        ...
        $('.nongli').html((D.getMonth()+1)+"月"+D.getDate()+"日 "+day+"("+sx22+") "+D.getHours()+":"+Minutes);
        }; 
